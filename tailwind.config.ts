    ...
    extend: {
      colors: {
        ...
        wave: {
          ...
          hover: "#182431",
          border: "#263241",
          "border-glow": "rgba(255,77,90,0.35)",
        },
      },
      fontFamily: {
      ...
      boxShadow: {
        card: "0 12px 32px -20px rgba(0,0,0,0.9)",
        "glow-purple": "0 0 22px -10px rgba(255,77,90,0.5)",
        "glow-pink": "0 0 22px -10px rgba(255,77,90,0.45)",
        "glow-cyan": "0 0 22px -10px rgba(30,167,255,0.4)",
        "card-hover": "0 20px 48px -24px rgba(0,0,0,0.95)",
